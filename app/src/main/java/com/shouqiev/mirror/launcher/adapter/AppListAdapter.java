 ...
 *****************************************************************************/
package com.shouqiev.mirror.launcher.adapter;
...
public class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.ViewHolder> {
    ...
    public int getItemCount() {
        return mAppList == null || mAppList.size() == 0? 0 : Integer.MAX_VALUE;
    }

    public AppInfo getItem(int position) {
        return mAppList == null ? null : mAppList.get(position%mAppList.size());
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            icon = (MirrorImageView) view.findViewById(R.id.more_recyclerview_item_icon);
