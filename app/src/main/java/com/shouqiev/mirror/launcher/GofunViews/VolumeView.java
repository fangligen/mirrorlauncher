...
public class VolumeView extends View {
    ...
    private static  int MIDDLE_WAVE_COLOR ;
    private static  int SMALL_WAVE_COLOR ;

    private static  int BIG_WAVE_COLOR ;

    private static final float MIDDLE_WAVE_SPEED = 1.4f;//小波速度
    private static final float SMALL_WAVE_SPEED = 1.3f;//小波速度

    private static final float BIG_WAVE_SPEED = 1.0f;//大波速度

    private static final int MIDDLE_WAVE_PERIOD = 12;
    private static final int SMALL_WAVE_PERIOD = 10;//小波周期
    ...
    private static final float MIDDLE_SINE_UP_AND_DOWN_MOVE = 1.0f;//大波 上移动或者下移动的比值
    private static final float BIG_SINE_UP_AND_DOWN_MOVE = 1.2f;//大波 上移动或者下移动的比值

    private static final float SMALL_SINE_UP_AND_DOWN_MOVE = 1.1f;//小波 上移动或者下移动的比值

    private static final float MIDDLE_AMPLITUDE_SIZE_SCALE = 10f;
    private static final float SMALL_AMPLITUDE_SIZE_SCALE = 8f;

    private static final float BIG_AMPLITUDE_SIZE_SCALE = 4f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        MIDDLE_WAVE_COLOR =getResources().getColor(R.color.color1);
         SMALL_WAVE_COLOR=getResources().getColor(R.color.color2);
        BIG_WAVE_COLOR =getResources().getColor(R.color.color3);
